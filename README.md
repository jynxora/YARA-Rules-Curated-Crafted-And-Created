...
| RegEx YARA Hunt | Detects obfuscated IPv4, Domain, Host, Sockets, URLs etc. + Python Automation | [READ PDF](Rule-4/RegexYARAHunt.pdf) | [READ MarkDown](Rule-4/RegexYARAHunt.md) |
